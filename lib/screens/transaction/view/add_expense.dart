...
class AddExpenseView extends GetView<TransactionController> {
  @override
  Widget build(BuildContext context) {
    controller.selectCatExpense.value = "food";

  var size = MediaQuery.of(context).size;
    return Scaffold(
        key: context.read<MenuAppController>().scaffoldKeyAddExpense,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                      ...
                      child: Padding(
                        ...
                        child: DropdownButton<String>(
                          ...
                          onChanged: (String? value) {
                            controller.selectCatExpense.value = value!;
                          },
                          items: controller.catList.map((value) {
                            return DropdownMenuItem<String>(
                              value: value.catName.toString(),
                  ...
                  GestureDetector(
                    onTap: () {
                      controller.addExpenseController().then((e) {
                        ...
                        controller.retrieveTransaction().then((value) {
                          ...
                          for (var element in controller.transactionList
                              .where((e) => e.type == "income")) {
                            controller.incomeList.add(element.amount!);
                            controller.totalIncome.value =
                                controller.incomeList.reduce((a, b) => a + b);
                          }
                          ...
                          for (var element in controller.transactionList
                            ...
                            controller.totalExpense.value =
                                controller.expenseList.reduce((a, b) => a + b);
                          }
