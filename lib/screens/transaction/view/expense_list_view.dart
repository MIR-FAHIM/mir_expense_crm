...
class ExpenseListView extends GetView<TransactionController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      return Scaffold(
          key: context.read<MenuAppController>().scaffoldKeyExpenseList,
          drawer: SideMenu(),
              ...
              children: <Widget>[
                ...
                Center(
                  child: Column(
                    children: [
                      // Text(
                      //   "test: ${controller.transactionList[5].date!.substring(5, 7)}",
                      //   style: TextStyle(color: AppColor.customYellow),
                      // ),
                      Text(
                          "Expense List (${controller.transactionList.where((e) => e.type == "expense" && int.parse(e.date!.substring(8, 10)) == controller.daySelection.value).length})"),
                      Text(
                    ...
                    child: ListView.builder(
                        itemCount: controller.transactionList
                            .where((e) =>
                                e.type == "expense"
                                    &&
                                int.parse(e.date!.substring(8, 11)) == controller.daySelection.value
                        &&
                            int.parse(e.date!.substring(5, 7)) == controller.monthSelection.value)
                            .length,
                              ...
                              children: <Widget>[
                                Container(
                                    ...
                                    decoration: BoxDecoration(
                                        color:
                                            AppColor.listTile.withOpacity(.7),
