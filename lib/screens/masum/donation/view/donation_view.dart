...
import 'package:flutter/material.dart';
import 'package:mir_expense_tracker/screens/masum/donation/controller/donation_controller.dart';
import 'package:mir_expense_tracker/screens/project/controller/project_controller.dart';
import 'package:provider/provider.dart';

class DonationList extends GetView<DonationController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        key: context.read<MenuAppController>().scaffoldKeyDonation,
